...
def render_review_html(manifest: Mapping[str, Any]) -> str:
    """Default Gold review always uses the confirmed UI 3.2 surface."""
    from scripts.v4_human_boundary_anchor_audit_ui import render_review_extension
    return render_review_extension(timing_manifest=manifest)


def render_legacy_review_html(manifest: Mapping[str, Any]) -> str:
    """Deprecated renderer retained only for explicit historical compatibility."""
