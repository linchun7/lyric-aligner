...
def build_best_safe(
    *,
    ...
    qa: dict[str, Any] = {
        ...
        "pre_release_publish_ready": publish_ready,
        "semantic_sensitive_review_required": True,
        "formal_safe_final_ready": False,
        "authority_scope": "best_safe_smart_timing_floor_not_max_release",
        "meaning": (
            "publish_ready is a pre-release selector result: Smart cue topology/timing were preserved except explicitly "
            "authorized boundary promotions, all supplied human timing truth passed, and text/display improvements passed "
            "their deterministic gates. A model-completed semantic-sensitive final gate is still required before this "
            "artifact may be called a formal Safe Final; track-level Max semantic PASS remains candidate evidence only "
            "and does not grant whole-track timing authority"
        ),
