...
v1.2.9 and the v1.2.9 repair function. Both the Smart CLI and Pro v1.2.4 import
through this facade.
...
Pro v1.2.4 still reports `timing_mutation_performed=false`. Automatic Pro
...
## Current superseding contract: Smart v1.2.9 / Pro v1.2.4

The current Smart facade binds `smart-1.1` to
`smart-validation-policy-2026-08-22-v1.2.9`. Shared canonical parsing filters
...
v1.2.8 queue/product semantics remain unchanged.

The current Pro policy is
`smart-to-pro-reason-aware-2026-08-22-v1.2.4`. Concrete actionable timing
...
text occurrence. v1.2.4 preserves that boundary while accepting Smart v1.2.9,
