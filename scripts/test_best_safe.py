...
class BestSafeTests(unittest.TestCase):
    ...
    def test_semantic_pass_is_candidate_only_and_smart_floor_is_unchanged(self):
        ...
        self.assertEqual(qa["sensitive_mask"]["profile"], "none")
        self.assertTrue(qa["publish_ready"])
        self.assertTrue(qa["pre_release_publish_ready"])
        self.assertTrue(qa["semantic_sensitive_review_required"])
        self.assertFalse(qa["formal_safe_final_ready"])
