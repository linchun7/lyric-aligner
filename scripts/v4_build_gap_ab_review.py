"""LEGACY ONLY: old offline gap UI. New reviews must use v4_listen.py / UI 3.2."""
...
if __name__=='__main__':
    ...
    parser.add_argument('--legacy-ui',action='store_true',help='Explicitly reproduce the deprecated historical gap page')
    ...
    if not args.legacy_ui:
        parser.error('This listening page is deprecated. Use scripts/v4_listen.py (UI 3.2); --legacy-ui is only for historical compatibility.')
    print('LEGACY UI: do not use this page for new production reviews.',file=sys.stderr)
